	...
	systemsData: {
		categories: {
			...
			'Threat Levels': {
				...
				'1': {
					name: 'Threat 1',
					color: colours[1][0].replace('#', ''),
				},
				'2': {
					name: 'Threat 2',
					color: colours[2][0].replace('#', ''),
				},
				'3': {
					name: 'Threat 3',
					color: colours[3][0].replace('#', ''),
				},
				'4': {
					name: 'Threat 4',
					color: colours[4][0].replace('#', ''),
				},
				'5': {
					name: 'Threat 5',
					color: colours[5][0].replace('#', ''),
				},
				'6': {
					name: 'Threat 6',
					color: colours[6][0].replace('#', ''),
				},
				'7': {
					name: 'Threat 7',
					color: colours[7][0].replace('#', ''),
				},
				'8': {
					name: 'Threat 8',
					color: colours[8][0].replace('#', ''),
				},
				'9': {
					name: 'Threat 9',
					color: colours[9][0].replace('#', ''),
				}
			}
		},
		systems: [
