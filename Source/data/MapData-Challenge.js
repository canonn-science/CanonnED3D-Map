...
{ 'points': [ {'s': '116 Tauri', 'label': '116 Tauri: Luteolum AnemoneCroceum AnemoneBlatteum Bioluminescent AnemoneRubeum Bioluminescent Anemone' }, {'s': 'Wredguia XD-K d8-24', 'label': 'Wredguia XD-K d8-24: Phoeniceum Gourd Mollusc           ' } ],'circle': false },
...
{ 'points': [ {'s': 'HIP 15310', 'label': 'HIP 15310: Q04-Type AnomalyQ08-Type Anomaly' }, {'s': 'Alaunus', 'label': 'Alaunus: Q09-Type Anomaly           ' } ],'circle': false },
...
{ 'points': [ {'s': 'HD 81946', 'label': 'HD 81946: Ostrinum Brain TreeRoseum Bioluminescent AnemoneAlbulum Gourd Mollusc' }, {'s': 'HD 63276', 'label': 'HD 63276: Lindigoticum Brain Tree           ' } ],'circle': false },
...
{ 'points': [ {'s': 'BD-12 1172', 'label': 'BD-12 1172: Lattice Mineral SpheresPrasinum Bioluminescent AnemoneViridans Gourd Mollusc' }, {'s': 'HIP 139', 'label': 'HIP 139: Puniceum Anemone           ' } ],'circle': false },
...
{ 'points': [ {'s': 'Ovomly HG-O d6-0', 'label': 'Ovomly HG-O d6-0: Luteolum Calcite PlatesLindigoticum Calcite PlatesViride Calcite PlatesRutulum Calcite PlatesBlatteum Torus Mollusc' }, {'s': 'Ovomly SS-K d8-8', 'label': 'Ovomly SS-K d8-8: Viride Torus Mollusc           ' } ],'circle': false },
...
{ 'points': [ {'s': 'Skaudai YP-O e6-17', 'label': 'Skaudai YP-O e6-17: Carpasinus Bell Mollusc' }, {'s': 'Graea Hypue DC-T d4-84', 'label': 'Graea Hypue DC-T d4-84: Puniceum Brain Tree Amphora Plant          ' } ],'circle': false },
{ 'points': [ {'s': 'Graea Hypue DC-T d4-84', 'label': 'Graea Hypue DC-T d4-84: Puniceum Brain TreeAmphora Plant' }, {'s': 'Blu Ain QC-M d7-3330', 'label': 'Blu Ain QC-M d7-3330: P10-Type Anomaly           ' } ],'circle': false },
...
{ 'points': [ {'s': 'Greae Phio DT-G d11-1570', 'label': 'Greae Phio DT-G d11-1570: Cymatilis Reel Mollusc' }, {'s': 'Eeshorks QI-B d1496', 'label': 'Eeshorks QI-B d1496: Luteolum Reel Mollusc           ' } ],'circle': false },
...
{ 'points': [ {'s': 'Gru Phio DV-W d2-440', 'label': 'Gru Phio DV-W d2-440: Roseum Sinuous TubersPrasinum Sinuous TubersAlbidum Sinuous TubersCaeruleum Sinuous Tubers' }, {'s': 'Gru Hypai DL-X e1-20', 'label': 'Gru Hypai DL-X e1-20: K02-Type Anomaly           ' } ],'circle': false },
{ 'points': [ {'s': 'Gru Hypai DL-X e1-20', 'label': 'Gru Hypai DL-X e1-20: K02-Type Anomaly' }, {'s': 'Blaa Hypai OZ-O d6-16', 'label': 'Blaa Hypai OZ-O d6-16: Cymatilis Bell Mollusc           ' } ],'circle': false },
{ 'points': [ {'s': 'Blaa Hypai OZ-O d6-16', 'label': 'Blaa Hypai OZ-O d6-16: Cymatilis Bell Mollusc' }, {'s': 'Eodgorsts TX-C b13-3', 'label': 'Eodgorsts TX-C b13-3: Q05-Type Anomaly           ' } ],'circle': false },
...
{ 'points': [ {'s': 'Trifid Sector DL-Y d157', 'label': 'Trifid Sector DL-Y d157: Roseum Lagrange CloudRubicundum Lagrange CloudPurpureum Metallic CrystalsAlbidum Collared PodRubicundum Collared Pod' }, {'s': 'HD 160167', 'label': 'HD 160167: Caeruleum Gourd Mollusc           ' } ],'circle': false },
...
{ 'points': [ {'s': 'Shrogaae KK-A d1049', 'label': 'Shrogaae KK-A d1049: Viride Octahedral PodChryseum Void Heart' }, {'s': 'Shrogaae KK-A d983', 'label': 'Shrogaae KK-A d983: Niveum Octahedral Pod           ' } ],'circle': false },
...
{ 'points': [ {'s': 'Juenae OX-U e2-8852', 'label': 'Juenae OX-U e2-8852: Roseum Lagrange Storm CloudL01-Type Anomaly' }, {'s': 'Phraa Pra HH-U e3-1354', 'label': 'Phraa Pra HH-U e3-1354: T02-Type Anomaly           ' } ],'circle': false },
...
{ 'points': [ {'s': 'Agnairy JH-U e3-2113', 'label': 'Agnairy JH-U e3-2113: Viride Lagrange Storm CloudT01-Type Anomaly' }, {'s': 'Dryoea Flyi II-S e4-6870', 'label': 'Dryoea Flyi II-S e4-6870: Luteolum Lagrange Storm Cloud Blatteum Sinuous Tubers Lindigoticum Sinuous Tubers Violaceum Sinuous Tubers Prasinum Metallic Crystals Rubeum Metallic Crystals Flavum Metallic Crystals K12-Type Anomaly    ' } ],'circle': false },
{ 'points': [ {'s': 'Dryoea Flyi II-S e4-6870', 'label': 'Dryoea Flyi II-S e4-6870: Luteolum Lagrange Storm CloudBlatteum Sinuous TubersLindigoticum Sinuous TubersViolaceum Sinuous TubersPrasinum Metallic CrystalsRubeum Metallic CrystalsFlavum Metallic CrystalsK12-Type Anomaly' }, {'s': 'Eol Prou IW-W e1-1868', 'label': 'Eol Prou IW-W e1-1868: Cymatilis Umbrella Mollusc           ' } ],'circle': false },
{ 'points': [ {'s': 'Eol Prou IW-W e1-1868', 'label': 'Eol Prou IW-W e1-1868: Cymatilis Umbrella Mollusc' }, {'s': 'Asura', 'label': 'Asura: Luteolum Umbrella Mollusc Virens Umbrella Mollusc          ' } ],'circle': false },
{ 'points': [ {'s': 'Asura', 'label': 'Asura: Luteolum Umbrella MolluscVirens Umbrella Mollusc' }, {'s': 'Wepaa BF-A f494', 'label': 'Wepaa BF-A f494: Caeruleum Lagrange Cloud Croceum Lagrange Cloud K01-Type Anomaly K03-Type Anomaly        ' } ],'circle': false },
{ 'points': [ {'s': 'Wepaa BF-A f494', 'label': 'Wepaa BF-A f494: Caeruleum Lagrange CloudCroceum Lagrange CloudK01-Type AnomalyK03-Type Anomaly' }, {'s': 'Wepaa BA-A g524', 'label': 'Wepaa BA-A g524: K05-Type Anomaly E04-Type Anomaly          ' } ],'circle': false },
{ 'points': [ {'s': 'Wepaa BA-A g524', 'label': 'Wepaa BA-A g524: K05-Type AnomalyE04-Type Anomaly' }, {'s': 'Wepaa GG-Y f343', 'label': 'Wepaa GG-Y f343: K04-Type Anomaly K06-Type Anomaly K08-Type Anomaly         ' } ],'circle': false },
{ 'points': [ {'s': 'Wepaa GG-Y f343', 'label': 'Wepaa GG-Y f343: K04-Type AnomalyK06-Type AnomalyK08-Type Anomaly' }, {'s': 'Wembeau KM-V e2-12', 'label': 'Wembeau KM-V e2-12: L03-Type Anomaly           ' } ],'circle': false },
...
{ 'points': [ {'s': 'Flyoo Groa SO-Z e0', 'label': 'Flyoo Groa SO-Z e0: Stolon PodStolon Tree' }, {'s': 'Aiphaisty YE-A d130', 'label': 'Aiphaisty YE-A d130: Q07-Type Anomaly           ' } ],'circle': false },
...
{ 'points': [ {'s': 'Vegnue UE-Q e5-33', 'label': 'Vegnue UE-Q e5-33: Luteolum Parasol MolluscViride Parasol Mollusc' }, {'s': 'Eorl Bre ZP-E d12-276', 'label': 'Eorl Bre ZP-E d12-276: Luteolum Bulb Mollusc           ' } ],'circle': false },
...
{ 'points': [ {'s': 'Joorai NI-K d8-9', 'label': 'Joorai NI-K d8-9: P08-Type AnomalyP09-Type Anomaly' }, {'s': 'Joorai NI-K d8-115', 'label': 'Joorai NI-K d8-115: P14-Type Anomaly           ' } ],'circle': false },
...
{ 'points': [ {'s': 'Phreia Byio PU-K c10-0', 'label': 'Phreia Byio PU-K c10-0: Purpureum Peduncle PodRufum Peduncle Pod' }, {'s': 'Plua Chruia IB-X d1-5', 'label': 'Plua Chruia IB-X d1-5: Albidum Chalice Pod           ' } ],'circle': false },
...
{ 'points': [ {'s': 'Pyrooe Dryiae CC-B d1-0', 'label': 'Pyrooe Dryiae CC-B d1-0: Cereum Aster PodCereum Aster Tree' }, {'s': 'Cliewoae DS-H d11-0', 'label': 'Cliewoae DS-H d11-0: Rubellum Aster Pod Rubellum Aster Tree          ' } ],'circle': false },
{ 'points': [ {'s': 'Cliewoae DS-H d11-0', 'label': 'Cliewoae DS-H d11-0: Rubellum Aster PodRubellum Aster Tree' }, {'s': 'Cliewoae VA-L d9-0', 'label': 'Cliewoae VA-L d9-0: Proto-Lagrange Cloud Purpureum Ice Crystals Rubeum Ice Crystals Albidum Ice Crystals Flavum Silicate Crystals Lindigoticum Aster Pod      ' } ],'circle': false },
{ 'points': [ {'s': 'Cliewoae VA-L d9-0', 'label': 'Cliewoae VA-L d9-0: Proto-Lagrange CloudPurpureum Ice CrystalsRubeum Ice CrystalsAlbidum Ice CrystalsFlavum Silicate CrystalsLindigoticum Aster Pod' }, {'s': 'Cliewoae UF-L d9-0', 'label': 'Cliewoae UF-L d9-0: Prasinum Aster Pod Prasinum Aster Tree          ' } ],'circle': false },
{ 'points': [ {'s': 'Cliewoae UF-L d9-0', 'label': 'Cliewoae UF-L d9-0: Prasinum Aster PodPrasinum Aster Tree' }, {'s': 'Pyrooe Dryiae ZQ-C d0', 'label': 'Pyrooe Dryiae ZQ-C d0: Puniceum Aster Pod           ' } ],'circle': false },
...
{ 'points': [ {'s': 'Braisao ZP-V d3-16', 'label': 'Braisao ZP-V d3-16: Candidum Peduncle PodCaeruleum Peduncle PodGypseeum Peduncle PodCaeruleum Peduncle TreeViride Peduncle TreeOstrinum Peduncle TreeRubellum Peduncle Tree' }, {'s': 'Oodgosly GI-B d13-11', 'label': 'Oodgosly GI-B d13-11: Viride Quadripartite Pod           ' } ],'circle': false },
...
{ 'points': [ {'s': 'Oodgosly AH-D d12-10', 'label': 'Oodgosly AH-D d12-10: Prasinum Ice CrystalsAlbidum Quadripartite PodCaeruleum Quadripartite Pod' }, {'s': 'Oodgosly AM-D d12-7', 'label': 'Oodgosly AM-D d12-7: Blatteum Quadripartite Pod           ' } ],'circle': false },
...
{ 'points': [ {'s': 'Dryeou Fleau XJ-A d0', 'label': 'Dryeou Fleau XJ-A d0: Roseum Ice CrystalsFlavum Ice CrystalsPrasinum Silicate CrystalsPurpureum Silicate CrystalsRubeum Silicate CrystalsCandidum Rhizome PodCobalteum Rhizome Pod' }, {'s': 'Drokoe AN-H d11-6', 'label': 'Drokoe AN-H d11-6: Albidum Silicate Crystals Cereum Bullet Mollusc          ' } ],'circle': false },
{ 'points': [ {'s': 'Drokoe AN-H d11-6', 'label': 'Drokoe AN-H d11-6: Albidum Silicate CrystalsCereum Bullet Mollusc' }, {'s': 'Thaile HW-V e2-7', 'label': 'Thaile HW-V e2-7: Croceum Lagrange Storm Cloud Albidum Peduncle Tree L06-Type Anomaly         ' } ],'circle': false },
{ 'points': [ {'s': 'Thaile HW-V e2-7', 'label': 'Thaile HW-V e2-7: Croceum Lagrange Storm CloudAlbidum Peduncle TreeL06-Type Anomaly' }, {'s': 'Eta Carina Sector JH-V c2-9', 'label': 'Eta Carina Sector JH-V c2-9: Luteolum Bell Mollusc           ' } ],'circle': false },
{ 'points': [ {'s': 'Eta Carina Sector JH-V c2-9', 'label': 'Eta Carina Sector JH-V c2-9: Luteolum Bell Mollusc' }, {'s': 'Eta Carina Sector EL-Y d19', 'label': 'Eta Carina Sector EL-Y d19: Viride Lagrange Cloud Luteolum Lagrange Cloud Solid Mineral Spheres Roseum Brain Tree Gypseeum Brain Tree Lividum Brain Tree Aureum Brain Tree Bark Mounds Cymatilis Silicate Crystals Roseum Silicate Crystals Albens Bell Mollusc ' } ],'circle': false },
{ 'points': [ {'s': 'Eta Carina Sector EL-Y d19', 'label': 'Eta Carina Sector EL-Y d19: Viride Lagrange CloudLuteolum Lagrange CloudSolid Mineral SpheresRoseum Brain TreeGypseeum Brain TreeLividum Brain TreeAureum Brain TreeBark MoundsCymatilis Silicate CrystalsRoseum Silicate CrystalsAlbens Bell Mollusc' }, {'s': 'GCRV 6493', 'label': 'GCRV 6493: P04-Type Anomaly           ' } ],'circle': false },
...
{ 'points': [ {'s': 'NGC 3199 Sector EB-X c1-6', 'label': 'NGC 3199 Sector EB-X c1-6: Lividum Bullet MolluscViride Bullet Mollusc' }, {'s': 'Drokoe FU-O b39-0', 'label': 'Drokoe FU-O b39-0: Rubeum Bullet Mollusc           ' } ],'circle': false },
...
{ 'points': [ {'s': 'Jongoae UX-L d7-0', 'label': 'Jongoae UX-L d7-0: Lindigoticum Ice CrystalsAurarium Gyre PodViridis Gyre TreeAurarium Gyre Tree' }, {'s': 'Eorgh Hypa RR-U c19-0', 'label': 'Eorgh Hypa RR-U c19-0: Roseum Gyre Pod           ' } ],'circle': false },
